...
schema = {
    ...
    'Paper':{'Rock':0,'Paper':1,'Scissor':2},
    'Scissor':{'Rock':2,'Paper':0,'Scissor':1}
}
...
lblsel = Label(mf,bg='#698B69',width=35,height=1,text="Please Select Rock, Paper Or Scissor ",font=('Arial',10,'italic','bold'))
lblsel.place(x= 80,y= 45)

player_score_label = Label(root,fg='#8B2500',bg='#698B69',text='Player Score: ' + str(player_score),font=('Arial',10,'bold'))
player_score_label.place(x = 15, y= 80)

comp_score_label = Label(root,fg='blue',bg='#698B69',text='Computer Score :' + str(player_score),font=('Arial',10,'bold'))
...
#Buttons
btnRock = Button(mf,text='Rock',height=2,width=10,bg= "#FCFCFC",fg='black',borderwidth=5,font=('Arial',11,'italic','bold'),command=lambda :outcome_of_game('Rock'))
btnRock.place(x= 20,y= 250)

btnPaper = Button(mf,text='Paper',height=2,width=10,bg= "#FCFCFC",fg='black',borderwidth=5,font=('Arial',11,'italic','bold'),command=lambda :outcome_of_game('Paper'))
btnPaper.place(x= 160,y= 250)

btnScissor = Button(mf,text='Scissor',height=2,width=10,bg= "#FCFCFC",fg='black',borderwidth=5,font=('Arial',11,'italic','bold'),command=lambda :outcome_of_game('Scissor'))
btnScissor.place(x=300,y= 250)

btnquit = Button(mf,text="Quit",height=2,width=8,bg= "#CD3700",fg='black',borderwidth=5,font=('Arial',11,'italic','bold'),command=root.quit)
